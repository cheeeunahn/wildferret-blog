...
The archive was difficult to review manually and too large to provide to an LLM in full. I therefore reorganised it as a wiki designed for efficient human and machine reading.

---

## Open Knowledge Format and the LLM Wiki

The design draws on two document formats for LLM-based knowledge systems that my team lead introduced to me.
...
Every quotation carries the research method and the sample size, and each concept page records how many studies back that concept up.

VOC quotes carry the ID of the original response, so any sentence can be traced back to its source.
...
I update the wiki whenever new research becomes available. This has largely eliminated the recurring search across Slack, Google Docs, and Confluence for earlier findings.
